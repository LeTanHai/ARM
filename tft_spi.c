...
{
	tft_drawFastVLine(x0, y0-r, 2*r+1);
...
void ILI9341_setRotation(uint8_t rotate)
{
	switch(rotate)
	{
		case 1:
			rotationNum = 1;
			tft_write_register(ILI9341_MEMCONTROL);
