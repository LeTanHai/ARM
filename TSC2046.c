...
void TSC2046_TL_point(void)
{
	BACK_COLOR = WHITE;
	POINT_COLOR = LBBLUE;
	tft_fillCircle(10,10,3);
	tft_puts8x16(20,30,(int8_t*)"Press here",TFT_STRING_MODE_BACKGROUND);
}
...
void TSC2046_BR_point(void)
{
	BACK_COLOR = WHITE;
	POINT_COLOR = LBBLUE;
	tft_fillCircle(myTS_Calibrate.Width-10, myTS_Calibrate.Height-10, 3);
	tft_puts8x16(myTS_Calibrate.Width-80, myTS_Calibrate.Height-40,(int8_t*)"Press here",TFT_STRING_MODE_BACKGROUND);
}
